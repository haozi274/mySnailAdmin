    ...
    <div class="layui-layout layui-layout-admin">
        <div class="layui-header">
            ...
            <ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
                ...
                <li class="layui-nav-item" lay-unselect>
                    <a lay-href="/sys/message/index" layadmin-event="message" lay-text="消息中心">
                ...
                <li class="layui-nav-item" lay-unselect>
                    <a href="javascript:;">
                        <img
                                <#if userInfo.iconString??>
                                    src="${userInfo.iconString}"
                                </#if>
                                src="/static/image/bpdwn.png"
                                width="35px" height="35px" style="border-radius: 100%">
                        <cite>${userInfo.username}</cite>
                    </a>
                    <dl class="layui-nav-child">
                        <dd><a lay-href="/api/user/userinfo">基本资料</a></dd>
                        <dd><a lay-href="/api/user/updatepwd">修改密码</a></dd>
                        <hr>
        ...
        <div class="layui-side layui-side-menu">
            <div class="layui-side-scroll">
                ...
                <div class="layui-bg-black"  style="width: 80px;height: 80px;border-radius: 100%;border: 0px;background: white;margin: 50px 45px -20px;">
                    <img
                         ...
                         <#if userInfo.iconString??>
                            ...
                            src="/static/image/bpdwn.png"
                         width="100px" height="100px" style="border-radius: 100%">

                </div>
                <span style="position: relative;top: 50px;left: 20%;font-size: 12px;bottom: 20px;">您好! ${userInfo.username}</span>
                <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu"
                    lay-filter="layadmin-system-side-menu">

                    <#list  meunlist as meun>
                        <#if (meun.list?size>0)>
                            <li data-name="home" class="layui-nav-item ">

                                <a href="javascript:;" lay-tips="${meun.name}" lay-direction="2">
                                    <i class="layui-icon "style="font-size: 18px">${meun.icon}</i>
                                    <cite>${meun.name}</cite>
                                </a>

                                <dl class="layui-nav-child">
                                    <#list meun.list as zi>

                                    <#--判断是否二级菜单-->
                                        <#if (zi.list?size=0)>
                                            <dd data-name="grid">
                                                <i class="layui-icon "style="font-size: 18px">${zi.icon}</i>
                                                <a lay-href="${zi.href} ">  &nbsp; &nbsp; &nbsp; ${zi.name}</a>
                                            </dd>
                                        </#if>
                                    <#--判断是否三级菜单-->
                                        <#if (zi.list?size>0)>
                                            <dd data-name="grid">
                                                ...
                                                <a href="javascript:; "> &nbsp; &nbsp; &nbsp;<i class="layui-icon "style="font-size: 18px">${zi.icon}</i>${zi.name}</a>
                                                <dl class="layui-nav-child">
                                                    <#list zi.list as two>
                                                        <dd data-name="list1">

                                                            <a lay-href="${two.href}">  &nbsp; &nbsp; &nbsp;<i class="layui-icon " style="font-size: 18px">${two.icon}</i> ${two.name}</a>
                                                        </dd>
                                                    </#list>
                                                </dl>
                                            </dd>
                    ...
                    <#--只有一级菜单的情况下-->
                        <#if meun.list?size=0>
                            <li data-name="get" class="layui-nav-item">
                                <span>
                                        <i class="layui-icon ">${meun.icon}</i>
                                      <a href="javascript:;" lay-href="${meun.href}" lay-tips="${meun.name}"
                                         lay-direction="2">
                   ...
                   <#-- <li data-name="home" class="layui-nav-item layui-nav-itemed">
                    ...
                    <li data-name="home" class="layui-nav-item ">
                        ...
                        <dl class="layui-nav-child">
                            <dd data-name="console">
                                <a lay-href="list">用户管理</a>
                            </dd>
                        </dl>
                        <dl class="layui-nav-child">
                            <dd data-name="console">
                                <a lay-href="/druid/index.html">Druid数据源</a>
                            </dd>
                        </dl>
                        <dl class="layui-nav-child">
                            <dd data-name="console">
                                <a lay-href="/api/log/list">系统日志</a>
                            </dd>
                        </dl>
                        <dl class="layui-nav-child">
                            <dd data-name="console">
                                <a lay-href="/sys/meun/list">系统菜单</a>
                            </dd>
                        </dl>

                        <dl class="layui-nav-child">
                            <dd data-name="console">
                                <a lay-href="/swagger-ui.html">swagger接口文档</a>
                            </dd>
                        </dl>
                    </li>-->
